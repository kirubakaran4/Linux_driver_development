...
MODULE_DESCRIPTION("An example for using GPIOs without the device tree when when we press the button connected to raspberry pi the led connected to 21 pin of pi will glow");
